...
fun main(){
    var s1=Student("MANN","vikani",20,20012011178,"CE","C","AB8")
    var s2=Student("vansh","Patel",20,20012011156,"CE","C","AB7")
    var s3=Student("meet","vikani",21,20012011179,"IT","B","AB3")
    var s4=Student("kevin","tilva",19,20012011173,"CE","A","AB9")
